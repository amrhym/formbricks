...
const Page = async (props) => {
  ...
  const integrationCards = [
    {
      docsHref: "/docs/xm-and-surveys/core-features/integrations/zapier",
      docsText: t("common.docs"),
      docsNewTab: true,
      connectHref: "https://zapier.com",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "/docs/xm-and-surveys/core-features/integrations/webhooks",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Webhooks",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "/docs/xm-and-surveys/core-features/integrations/google-sheets",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Google Sheets",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "/docs/xm-and-surveys/core-features/integrations/airtable",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Airtable",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "/docs/xm-and-surveys/core-features/integrations/slack",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Slack",
    ...
    {
      docsHref: "/docs/xm-and-surveys/core-features/integrations/n8n",
    ...
    {
      docsHref: "/docs/xm-and-surveys/core-features/integrations/make",
      docsText: t("common.docs"),
      docsNewTab: true,
      connectHref: "https://www.make.com",
      connectText: t("common.connect"),
      connectNewTab: true,
      label: "Make.com",
    ...
    },
    {
      ...
      connectNewTab: false,
      docsHref: "/docs/xm-and-surveys/core-features/integrations/notion",
      docsText: t("common.docs"),
      docsNewTab: true,
      label: "Notion",
    ...
    {
      docsHref: "/docs/xm-and-surveys/core-features/integrations/activepieces",
      docsText: t("common.docs"),
      docsNewTab: true,
      connectHref: "https://www.activepieces.com",
      connectText: t("common.connect"),
      connectNewTab: true,
      label: "Activepieces",
  ...
  integrationCards.unshift({
    docsHref: "/docs/app-surveys/quickstart",
    docsText: t("common.docs"),
    docsNewTab: true,
